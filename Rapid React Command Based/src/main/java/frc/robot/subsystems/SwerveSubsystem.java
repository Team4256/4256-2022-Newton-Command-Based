...
public class SwerveSubsystem extends SubsystemBase {
  private final SwerveModule moduleA = new SwerveModule (
    ...
    private final SwerveDriveOdometry odometer = new SwerveDriveOdometry(Parameters.DRIVE_KINEMATICS,
            new Rotation2d(0));
  ...
  public void periodic() {
    odometer.update(getRotation2d(), moduleA.getState(), moduleB.getState(), moduleC.getState(),
                moduleD.getState());
...
public void setModuleStates(SwerveModuleState[] desiredStates) {
    SwerveDriveKinematics.desaturateWheelSpeeds(desiredStates, Parameters.MAX_METERS_PER_SECOND);
