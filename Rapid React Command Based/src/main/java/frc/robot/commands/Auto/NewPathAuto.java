...
public class NewPathAuto extends SequentialCommandGroup {
  ...
  PathPlannerTrajectory autoPath = PathPlanner.loadPath("New Path", 1, 1);
  ...
  public NewPathAuto() { 
    addCommands(
      ...
      new InstantCommand(() -> gyro.resetWithOffset(90)),
