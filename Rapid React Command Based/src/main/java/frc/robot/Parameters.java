...
public class Parameters{
    ...
    public static final double TELEOP_SPEED_LIMIT_MPS = MAX_METERS_PER_SECOND / 4;
    ...
    //INTAKE
    public static final int SUCCMOTOR_ID = 16;
    public static final int INTAKE_FORWARD_CHANNEL = 0;
    public static final double INTAKE_SUCC_MOTOR = 0.4;
